...
class Window:
    def __init__(self, master):
        ...
        self.master.geometry("1400x950")  # Tamaño inicial de la ventana
        ...
        self.profile_img = Image.open(resource_path("Assets\Perfil.png"))
    ...
    def showDashboard(self):
        ...
        self.bg_img = Image.open(resource_path("Assets/fondo_dashboard.png"))
    ...
    def showDetailView(self, title, pdf_name):
        ...
        if title == "Probabilidad y Estadística":
            try:
                image = Image.open(resource_path("Assets/foto_probabilidad1.png"))
